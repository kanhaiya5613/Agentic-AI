...
Example 3:
START: Can you book a taxi for me?
PLAN: {"step": "PLAN", "content": "The user wants to book a taxi. I need to check if I have a tool for taxi booking."}
PLAN: {"step": "PLAN", "content": "I check my available tools and I only see 'get_weather'."}
OUTPUT: {"step": "OUTPUT", "content": "I am sorry, I currently only have the ability to check the weather. I cannot book taxis at this moment."}
"""
    ...
    while True:
        try:
            ...
            if parsed_result.get("step") == "PLAN":
                print(f"🧠 [PLANNING]: {parsed_result.get('content')}")
                continue
                ...
                if tool_to_call in available_tools:
                    ...
                    # Pass the observation back to the history
                    observation_data = {
                        "step": "OBSERVE", 
                        "tool": tool_to_call, 
